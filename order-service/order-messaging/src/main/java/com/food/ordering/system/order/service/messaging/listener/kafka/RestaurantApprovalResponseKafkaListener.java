...
import com.food.ordering.system.order.service.domain.RestaurantApprovalResponseMessageListener;
    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
         ...
         messages.forEach(restaurantApprovalResponseAvroModel -> {
             if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()){
                 ...
                 log.info("Processing rejected order for order id: {}, failureMessages: {}",restaurantApprovalResponseAvroModel.getOrderId(),String.join(FAILURE_MESSAGE_DELIMITER,restaurantApprovalResponseAvroModel.getFailureMessages()));
