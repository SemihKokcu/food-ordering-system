...
import com.food.ordering.system.order.service.dataaccess.order.entitiy.OrderItemEntityId;
...
public class OrderDataAccessMapper {
        ...
        public OrderEntity orderToOrderEntity(Order order){
            OrderEntity orderEntity = OrderEntity.builder()
                    ...
                    .address(deliveryAdressToAdressEntity(order.getDeliveryAddress()))
    ...
    private OrderAddressEntity deliveryAdressToAdressEntity(StreetAddress deliveryAddress) {
